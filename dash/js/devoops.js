...
$(document).ready(function () {
	...
	$('.main-menu').on('click', 'a', function (e) {
		...
		if ($(this).hasClass('ajax-link')) {
			e.preventDefault();
			if (typeof fetch_group_chat !== 'undefined'){
				clearInterval(fetch_group_chat);
			}
			if (typeof fetch_posts !== 'undefined'){
				clearInterval(fetch_posts);
			}
			if (typeof fetch_onetoone_chat !== 'undefined'){
				clearInterval(fetch_onetoone_chat);
			}
			if (typeof fetch_whiteboard !== 'undefined'){
				clearInterval(fetch_whiteboard);
			}
